...
export const Hero = () => {
    ...
    return (
        <section className="w-full px-4 sm:px-6 lg:px-8 pt-28 pb-12 bg-white relative z-0">
            <div className="relative overflow-hidden w-full max-w-[1500px] mx-auto rounded-[2.5rem] border border-blue-100/80 bg-gradient-to-b from-[#E2EFFF] via-[#F4F8FF] to-white pt-16 pb-20 lg:pt-24 lg:pb-32 shadow-sm">
                {/* Background Abstract Shapes */}
                <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-white/40 blur-3xl pointer-events-none -z-10" />
                <div className="absolute bottom-[-10%] right-[-5%] w-[40vw] h-[40vw] rounded-full bg-blue-50/60 blur-3xl pointer-events-none -z-10" />
